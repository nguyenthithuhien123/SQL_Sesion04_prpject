...
select p.product_Name, bb.auth_Date, min(b.quantity) from PRODUCT p join BILL_DETAIL b
on p.product_Id = b.product_Id
join BILL bb
on b.bill_Id = bb.bill_Id
where bb.auth_Date between '2024-1-1' and '2024-12-1'
...
select p.product_Name, sum(b.quantity*b.price) as 'total' from PRODUCT p join BILL_DETAIL b
on p.product_Id = b.product_Id
join BILL bb
on b.bill_Id = bb.bill_Id
...
join BILL bb
on b.bill_Id = bb.bill_Id
where bb.auth_Date between '2024-1-1' and '2024-12-1'and bb.bill_Type=0
group by p.product_Name;
